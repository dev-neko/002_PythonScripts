...
def reselve(driver):
	...
	# 日付・時刻は変数にしたい
	# driver.find_element_by_xpath("//*[text()='2月23日(火)']").click()
	driver.find_element_by_xpath("//*[contains(text(), '2月20日')]").click()
...
# schedule.every().day.at("08:30:00").do(reselve, driver=driver)
# while True:
